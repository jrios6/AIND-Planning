...
class AirCargoProblem(Problem):
    ...
    def result(self, state: str, action: Action):
        ...
        #converts the state string into the lists of positive and negative fluents in the old state,
        ...
        #converts back into state string representation.
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        executed.
        '''
        # Counts number of claues that are unmet at current state
        # Assumes every goal condition can be satisfied
        count = 0
        kb = PropKB()
